...
public class A_PagingDto {
	...
	public A_PagingDto(int page) {
		this.page = page;
	}

	public A_PagingDto(int page, int startRow, int endRow, int count) {
		super();
		this.page = page;
	...
	public String toString() {
		return "aPagingDto [page=" + page + ", startRow=" + startRow + ", endRow=" + endRow + ", count=" + count
