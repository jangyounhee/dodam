						...
						<c:forEach var="adoptVo" items="${adList}">
							<div class="col mb-5">
								<div class="card h-100">
									<a href="/admin/adminAnimalCont?ad_no=${adoptVo.ad_no}"><img class="card-img-top" style="height:180px; width:236.5px;" src="http://localhost/adopt/displayImage?fileName=${adoptVo.ad_picture}" alt="..." /></a>
									...
									<div class="card-footer pt-0 border-top-0 bg-transparent">
										<div class="text-center">
											<a class="btn btn-sm btn-outline-warning" href="/admin/animalModiForm?ad_no=${adoptVo.ad_no}">수정</a>
											<a class="btn btn-sm btn-outline-danger" href="/admin/animalDeleteRun?ad_no=${adoptVo.ad_no}">삭제</a>
										</div>
									</div>
								</div>
							</div>
