...
<form id="frmPaging" action="/admin/adminCustomerBoard" method="get">
						...
						<c:forEach var="customerBoardVo" items="${list}">
							<tr>
								...
								<c:when test="${customerBoardVo.re_level > 0}">
									<a href="/admin/adminCustomerReplyContent?cb_no=${customerBoardVo.cb_no}"
									 style="margin-left:${customerBoardVo.re_level * 30}px">
									 <c:if test="${customerBoardVo.re_level > 0}"> ㄴ </c:if>${customerBoardVo.cb_title}</a>
								</c:when>
									<c:otherwise>
										<a href="/admin/adminCustomerContent?cb_no=${customerBoardVo.cb_no}"
										style="margin-left:${customerBoardVo.re_level * 30}px">
										<c:if test="${customerBoardVo.re_level > 0}"> ㄴ </c:if>${customerBoardVo.cb_title}</a>
									</c:otherwise>
								</c:choose>
