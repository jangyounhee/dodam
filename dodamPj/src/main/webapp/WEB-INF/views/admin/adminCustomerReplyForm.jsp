...
<div class="container-fluid">
	...
	<div class="row" style="margin-top:10px;">
		<div class="col-md-2">
			...
			<div class="col-md-10">
				<form role="form" action="/admin/adminCustomerReplyRun" method="post">
				<input type="hidden" name="cb_no" value="${customerBoardVo.cb_no}"/>
				<input type="hidden" name="re_group" value="${customerBoardVo.re_group}"/>
				<input type="hidden" name="re_seq" value="${customerBoardVo.re_seq}"/>
				<input type="hidden" name="re_level" value="${customerBoardVo.re_level}"/>
				<input type="hidden" name="user_id" value="${sessionScope.loginVo.user_id }">
					<div class="form-group">
						<span style="font-size:30px"><label style="font-weight:bold">문의하기 답글</label></span>
						<table class="table">
						<tbody>
							<tr>
								<td align="center">제목</td>
								<td align="center"></td>
								<td><input type="text" class="form-control" id="cb_title" name="cb_title" value="RE:${customerBoardVo.cb_title }"/></td>
							</tr>
							<tr>
								<td align="center">내용</td>
								<td align="center"></td>
								<td>
									<textarea name="reply" id="editor" wrap="hard" rows="10" cols="100" placeholder="내용을 입력하세요."></textarea>
					...
					<a href="adminCustomerBoard" class="btn btn-danger">취소</a>
				</form>
			</div>
		</div>
	</div>
