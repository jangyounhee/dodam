...
<form id="frmPaging" action="/admin/adminProtectList" method="get">
							...
							<c:forEach var="animalVo" items="${aList}">
								<div class="col mb-5">
									<div class="card h-100">
										<!-- Product image-->
										<img class="card-img-top" style="height:160px; width:236.5px;" src="http://localhost/admin/displayImage?fileName=${animalVo.a_picture}" alt="..." />
										...
										<div class="card-footer pt-0 border-top-0 bg-transparent">
											<div class="text-center">
												<a class="btn btn-outline-dark mt-auto" style="margin-bottom:2px;"
													href="/admin/adminProtectCont?a_no=${animalVo.a_no}">자세히보기</a><br>
												<a class="btn btn-sm btn-outline-info" href="/admin/adminProtectModiForm?a_no=${animalVo.a_no}">수정</a>
												<a class="btn btn-sm btn-outline-danger" href="/admin/adminDeleteProtectRun?a_no=${animalVo.a_no}">삭제</a>
											</div>
										</div>
									</div>
								</div>
