...
$(document).ready(function() {
	$("#btnDelete").click(function() {
		if (confirm("삭제하시겠습니까?")) {
			location.href = "/customerboard/deleteRun?cb_no=${customerBoardVo.cb_no}";
		}
	});
...
<div class="container-fluid">
	...
	<div class="row" style="margin-top:10px;">
		<div class="col-md-2">
			...
			<div class="col-md-10">
				<form role="form">
					<input type="hidden" name="user_id" value="${customerBoardVo.user_id }"/>
					...
					<div class="form-group">
						...
						<tbody>
							<tr>
								...
								<td align="center"></td>
								<td><input type="text" class="form-control" id="user_id" name="user_id" value="${customerBoardVo.user_id }" readonly/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									...
									<script language="javascript">
										var tmpStr = "${customerBoardVo.cb_content }";
				...
				<div class="row">
					...
					<div class="row">
						<div class="col-md-12">
						<c:if test="${loginVo.user_id == customerBoardVo.user_id }">
							<a class="btn btn-primary" id="btnModify" href="/customerboard/modifyForm?cb_no=${customerBoardVo.cb_no }">수정</a>
<!-- 							<button type="submit" class="btn btn-success" id="btnModifyFinish" style="display:none">수정완료</button> -->
							<button type="button" class="btn btn-danger" id="btnDelete">삭제</button>
						</c:if>
							<a class="btn btn-warning" href="customerBoard">목록</a>
						</div>
					</div>
				</form>
