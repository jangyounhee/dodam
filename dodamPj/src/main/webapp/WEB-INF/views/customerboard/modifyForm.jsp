...
<div class="container-fluid">
	...
	<div class="row" style="margin-top:10px;">
		<div class="col-md-2">
			...
			<div class="col-md-10">
				<form role="form" action="/customerboard/modifyRun" method="post">
					...
					<div class="form-group">
						...
						<tbody>
							...
							<tr>
								...
								<td align="center"></td>
								<td><input type="text" class="form-control" id="cb_title" name="cb_title" value="${customerBoardVo.cb_title }"/></td>
							</tr>
							<tr>
								<td align="center">내용</td>
								<td align="center"></td>
								<td>
									<textarea name="cb_content" id="editor" wrap="hard" rows="10" cols="100">${customerBoardVo.cb_content }</textarea>
