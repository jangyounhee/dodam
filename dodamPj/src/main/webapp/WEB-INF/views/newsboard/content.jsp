...
var loginVoId = "${loginVo.user_id}";
	...
	$("#btnCommentList").click(function() {
		var url = "/comment/animalGetCommentList/${newsBoardVo.ab_no}";
	...
	$("#btnCommentInsert").click(function() {
		...
		var ab_no = parseInt("${newsBoardVo.ab_no}");
		var url = "/comment/animalInsertComment";
		var sendData = {
				"c_content" : c_content,
				"ab_no"	    : ab_no
		};
...
<%-- 									<c:if test="${loginVo.user_id == memberVo.user_id }"> --%>
					...
					<div class="row">
						<div class="col-md-12">
							<a class="btn btn-warning" href="newsBoard">목록</a>
						</div>
					</div>
				</form>
			</div>
